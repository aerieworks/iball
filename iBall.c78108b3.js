...
})({"lL3mV":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a75d6b58c78108b3";
...
},{}],"gMHKG":[function(require,module,exports) {
...
function initialize(rootId) {
    console.log("rootId:", rootId);
    const root = document.getElementById(rootId);
    if (!root) throw "Could not find root element '${rootId}'";
    const configPanel = new (0, _config.ConfigPanel)(root);
    const target = new (0, _targetDefault.default)(root, configPanel);
    target.render();
}

},{"./target":"jHTQH","./config":"gTux2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jHTQH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Target {
    constructor(parentElement, configPanel){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lL3mV"], null, "parcelRequirea3e6")

//# sourceMappingURL=iBall.c78108b3.js.map
